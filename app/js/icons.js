...
// ── Glyph icon set (Lucide, ISC-licensed — see NOTICE) ──
// Stroke glyphs on a 0 0 24 24 grid, rendered via currentColor. These replace
// the emoji that were previously used as iconography across component cards,
// tours, section headers, and search results.
const GLYPH_PATHS = {
...
// before lookup, so "⚙️" and "⚙" both resolve.
const EMOJI_TO_GLYPH = {
  "📋": "clipboard-list", "📝": "file-pen-line", "📊": "chart-column",
  "🔄": "refresh-cw", "🔍": "search", "🎯": "target", "📈": "trending-up",
  "💊": "pill", "⚙": "settings", "📦": "package", "🏥": "building-2",
  "📅": "calendar", "💬": "message-circle", "📄": "file-text", "🤖": "bot",
  "🔗": "link", "🗺": "map", "📆": "calendar", "💰": "dollar-sign",
  "📚": "book-open", "🏷": "tag", "🧩": "puzzle", "✍": "file-pen-line",
  "👥": "users", "⭐": "star", "📤": "upload", "🗓": "calendar", "🔑": "key",
  "🏖": "palmtree", "💡": "lightbulb", "🤝": "handshake", "✅": "file-check",
  "❓": "help", "📹": "video", "🎬": "film", "✉": "mail", "🏢": "building",
  "🛑": "octagon-alert", "🔔": "bell", "📜": "scroll", "🗂": "folder",
  "🌳": "trees", "🌐": "globe", "⚡": "zap", "🧪": "flask-conical",
  "🎲": "dices", "🖥": "monitor", "🧬": "dna", "💜": "heart", "🛡": "shield",
  "💉": "syringe", "🩺": "stethoscope", "📃": "file-text", "👤": "user",
  "💻": "code", "🔀": "refresh-cw", "🧠": "lightbulb", "💳": "dollar-sign",
...
export function iconHtml(value, size = 20) {
  ...
  const name = EMOJI_TO_GLYPH[key] || key;
