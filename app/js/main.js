...
async function loadProductData() {
  ...
  const [configModule, dataModule] = await Promise.all([
    import(`${productsBase}/config.js?v=12`),
    import(`${productsBase}/data.js?v=12`),
  ]);
  ...
  try {
    const iconsModule = await import(`${productsBase}/icons.js?v=12`);
  ...
  // Load tours (optional)
  try {
    const tourModule = await import(`${productsBase}/tour-data.js?v=12`);
  ...
  try {
    const feedbackModule = await import(`${productsBase}/feedback.js?v=12`);
  ...
  try {
    const aiContextMod = await import(`${productsBase}/ai-context.js?v=12`);
...
const loadEntities = async () => {
  try {
    const module = await import(`${productsBase}/entities.js?v=12`);
